...
'pf-title': 'Portfolio — Matías Aguetti',
'pf-sub': 'Proyectos seleccionados con descripción, tecnologías y resultados.',

'pf-nomlogo-title': 'Nomlogo — Estrategia de contenidos y SEO',
'pf-nomlogo-role': 'Rol: Miembro del equipo de contenidos y SEO strategist.',
'pf-nomlogo-desc': 'Planificación e implementación de estrategias de contenidos para el blog, focalizadas en keywords relacionadas con mantenimiento web, diseño y desarrollo en WordPress.',
'pf-nomlogo-tech': 'Tecnologías / herramientas: WordPress, Google Search Console, Google Analytics, Ahrefs (o similar).',
'pf-nomlogo-results': 'Resultados: Posicionamiento del sitio en primeros puestos para keywords estratégicas (métricas disponibles bajo petición).',

'pf-club-title': 'Club de Inversores — Plataforma de membresías',
'pf-club-desc': 'Desarrollo con Elementor; integración con HubSpot y s2Member para venta de membresías orientadas a cursos sobre finanzas e inversiones.',
'pf-club-tech': 'Tecnologías / herramientas: WordPress, Elementor, HubSpot, s2Member, APIs para pasarelas y analytics.',
'pf-club-results': 'Resultados: Incremento de clics orgánicos de ~20/día a ~220/día en 6 meses tras estrategia de contenidos y SEO.',

'pf-villas-title': 'Villas Zamná — Motor de reservas y multilenguaje',
'pf-villas-desc': 'Sitio para reservas de villas en Cozumel; integración con Hostaway vía API, motor de reservas inyectado y multilenguaje con WPML.',
'pf-villas-tech': 'Tecnologías / herramientas: Divi (child theme), WPML, Hostaway API, JS personalizado para popups y motor de reservas.',
'pf-villas-results': 'Resultados: +60% en interacciones orgánicas en 6 meses y +40% en conversiones directas a reservas en Hostaway.',

'pf-case': 'Ver caso',
'contact-title': 'Contacto',
'contact-sub': '¿Listo para trabajar? Contáctame por WhatsApp o correo.',
    },
    en: {
...
'pf-title': 'Portfolio — Matías Aguetti',
'pf-sub': 'Selected projects with descriptions, technologies and results.',

'pf-nomlogo-title': 'Nomlogo — Content strategy & SEO',
'pf-nomlogo-role': 'Role: Member of content team and SEO strategist.',
'pf-nomlogo-desc': 'Planning and implementing content strategies for the blog focused on keywords related to WordPress maintenance, design and development.',
'pf-nomlogo-tech': 'Tech / tools: WordPress, Google Search Console, Google Analytics, Ahrefs (or similar).',
'pf-nomlogo-results': 'Results: Ranked the site for strategic keywords (metrics available upon request).',

'pf-club-title': 'Club de Inversores — Membership platform',
'pf-club-desc': 'Built with Elementor; HubSpot integration and s2Member for memberships selling courses on finance and investments.',
'pf-club-tech': 'Tech / tools: WordPress, Elementor, HubSpot, s2Member, payment & analytics APIs.',
'pf-club-results': 'Results: Organic clicks increased from ~20/day to ~220/day in 6 months after content & SEO strategy.',

'pf-villas-title': 'Villas Zamná — Booking engine & multilingual',
'pf-villas-desc': 'Booking site for private villas in Cozumel; Hostaway API integration, injected booking engine and WPML multilingual setup.',
...
'pf-title': 'Portfólio — Matías Aguetti',
'pf-sub': 'Projetos selecionados com descrição, tecnologias e resultados.',

'pf-nomlogo-title': 'Nomlogo — Estratégia de conteúdos e SEO',
'pf-nomlogo-role': 'Papel: Membro da equipe de conteúdo e SEO strategist.',
'pf-nomlogo-desc': 'Planejamento e implementação de estratégias de conteúdo para o blog, focadas em palavras-chave relacionadas a manutenção, design e desenvolvimento em WordPress.',
'pf-nomlogo-tech': 'Tecnologias / ferramentas: WordPress, Google Search Console, Google Analytics, Ahrefs (ou similar).',
'pf-nomlogo-results': 'Resultados: Posicionamento do site nos primeiros lugares para keywords estratégicas (métricas disponíveis sob pedido).',

'pf-club-title': 'Club de Inversores — Plataforma de assinaturas',
'pf-club-desc': 'Desenvolvido com Elementor; integração com HubSpot e s2Member para venda de assinaturas e cursos sobre finanças e investimentos.',
'pf-club-tech': 'Tecnologias / ferramentas: WordPress, Elementor, HubSpot, s2Member, APIs para gateways e analytics.',
'pf-club-results': 'Resultados: Aumento de cliques orgânicos de ~20/dia para ~220/dia em 6 meses após estratégia de conteúdo e SEO.',

'pf-villas-title': 'Villas Zamná — Motor de reservas e multilíngue',
